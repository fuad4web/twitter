    ...
    if(isset($_POST['submit'])) {
        ...
        if(!empty($username) && !empty($email)) {
            if($user->username != $username and $getFromU->checkUsername($username) === true) {
                ...
                $error['username'] = "All Characters should be Letters and Numbers";
            } else if(!filter_var($email, FILTER_VALIDATE_EMAIL)) {
                $error['fields'] = "Invalid Email";
			...
			<div class="inner-lefter">
				...
				<div class="acc-info-wrap">
					<div class="acc-info-bg">
						<!-- PROFILE-COVER -->
						<img src="<?= BASE_URL.$user->profileCover; ?>"/>  
					</div>
				...
				<div class="option-box">
					<ul> 
						<li>
							<a href="<?= BASE_URL; ?>settings/account" class="bold">
							<div>
								Account
						...
						<li>
							<a href="<?= BASE_URL; ?>settings/password">
							<div>
								Password
								<span><i class="fa fa-angle-right" aria-hidden="true"></i></span>
							</div>
